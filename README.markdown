...
adaptiveHeight | boolean | true | Adapts slider height to the current slide
autoplay | boolean | false | Enables auto play of slides
autoplaySpeed | int  | 3000 | Auto play change interval
centerMode | boolean | true | Enables centered view with partial prev/next slides. Use with odd numbered slidesToShow counts.
...
variableWidth | boolean | true | Disables automatic slide width calculation
